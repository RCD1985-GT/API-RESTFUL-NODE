...
module.exports = {
  async up (queryInterface, Sequelize) {
     await queryInterface.bulkInsert('usuarios', [ // QUITO BCRYPT PARA COMPROBAR QUE FUNCIONA "password":bcrypt.hashSync("1234", Number.parseInt(authConfig.rounds))
      {"nombre":"Katleen","apellido":"Tomasello","email":"ktomasello0@tripadvisor.com","edad":10,"password":"1234","rol":true,"createdAt":"2021-12-17","updatedAt":"2021-05-31"},// CAMBIAR LOS ROLS TRUE
